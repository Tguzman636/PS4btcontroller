...
// UART Communication
#define remoteHasControl 8 // When this pin is high, PS4 remote will have motion contol 
...
char data_rcvd == '1'; // PS4 remote starts out with control
...
void setup() {
  ...
  pinMode(remoteHasControl, OUTPUT);
  digitalWrite(remoteHasControl, HIGH);
...
void PatientMode() {
  Serial.write('0'); // Patient Mode has been activated
