...
#define ANSWERSIZE 11    // Slave Answer Size
...
void PatientMode() {
  remoteHasControl = !remoteHasControl;
  // Case 1: Give control to gamebar
  if (remoteHasControl == false) {
    Serial.println("Write data to slave");

    Wire.beginTransmission(SLAVE_ADDR);
    Wire.write("Gamebar Onn"); // example message
  ...
  // End Case
 // Case 2: Give control to remote
if (remoteHasControl == true){
